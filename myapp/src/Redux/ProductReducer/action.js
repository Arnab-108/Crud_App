...
export const addProduct = (obj)=>(dispatch)=>{
    ...
    return axios.post("http://localhost:8080/products",obj).then((res)=>{
        console.log(res)
...
export const patchProduct=(obj,id)=>(dispatch)=>{
    dispatch({type:ADD_PRODUCT_REQUEST})

    return axios.patch(`http://localhost:8080/products/${id}`,obj).then((res)=>{
